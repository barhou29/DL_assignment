...
Original file is located at
    https://colab.research.google.com/github/d2l-ai/d2l-en-colab/blob/master/chapter_computer-vision/kaggle-cifar10.ipynb
...
batch_size = 70 if demo else 128
valid_ratio = 0.1
...
net.hybridize()
train(net, train_iter, valid_iter, 100, lr, wd, devices, lr_period,
      lr_decay)
